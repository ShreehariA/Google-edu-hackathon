...
5. AFTER SCOPEGATEAGENT RETURNS
   ...
   then check {temp:scope_rejected?}:
     - if True: respond with {temp:scope_rejected_message?}
                offer the nearest chapter from {chapters} and ask if they want to switch to it
